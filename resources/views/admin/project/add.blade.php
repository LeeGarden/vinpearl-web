              ...
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="name" id="name" value="{{ old('name') }}" placeholder="Tên Dự án">
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <textarea name="description" placeholder="Mô tả chung" style="width: 100%; height: 120px; font-size: 14px; line-height: 18px;  border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="link_video" id="link_video" value="{{ old('link_video') }}" placeholder="Link video">
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <textarea name="overview" class="textarea" placeholder="Mô tả Tổng quan dự án" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <textarea name="des_location" class="textarea" placeholder="Mô tả Vị trí" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <textarea name="des_og" class="textarea" placeholder="Mô tả Mặt bằng" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <textarea name="des_villas" placeholder="Giới thiệu chung Các mẫu villas"  style="width: 100%; height: 120px; font-size: 14px; line-height: 18px;  border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="sample1" id="sample1" value="{{ old('sample1') }}" placeholder="Tên mẫu Villa 1">
                      </div>
                      <!-- /.input group -->
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="sample2" id="sample2" value="{{ old('sample2') }}" placeholder="Tên mẫu Villa 2">
                      </div>
                      <!-- /.input group -->
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="sample3" id="sample3" value="{{ old('sample3') }}" placeholder="Tên mẫu Villa 3">
                      </div>
                      <!-- /.input group -->
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="sample4" id="sample4" value="{{ old('sample4') }}" placeholder="Tên mẫu Villa 4">
                      </div>
                      <!-- /.input group -->
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="sample5" id="sample5" value="{{ old('sample5') }}" placeholder="Tên mẫu Villa 5">
                      </div>
                      <!-- /.input group -->
                    </div>
                    <div class="form-group">
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="inve1" id="inve1" value="{{ old('inve1') }}" placeholder="Tên Chính sách 1">
                        <textarea class="textarea" name="des_iv1" placeholder="Nội dung Chính sách 1" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="inve2" id="inve2" value="{{ old('inve2') }}" placeholder="Tên Chính sách 2">
                        <textarea class="textarea" name="des_iv2" placeholder="Nội dung Chính sách 2" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="inve3" id="inve3" value="{{ old('inve3') }}" placeholder="Tên Chính sách 3">
                        <textarea class="textarea" name="des_iv3" placeholder="Nội dung Chính sách 3" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="inve4" id="inve4" value="{{ old('inve4') }}" placeholder="Tên Chính sách 4">
                        <textarea class="textarea" name="des_iv4" placeholder="Nội dung Chính sách 4" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <input type="text" class="form-control" name="inve5" id="inve5" value="{{ old('inve5') }}" placeholder="Tên Chính sách 5">
                        <textarea class="textarea" name="des_iv5" placeholder="Nội dung Chính sách 5" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <textarea class="textarea" name="payment" placeholder="Mô tả Tiến độ Thanh toán" style=""></textarea>
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
                ...
                <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="input-group col-sm-5">
                        <textarea class="textarea" name="const" placeholder="Mô tả Tiến độ Xây dựng" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                      </div>
                      <!-- /.input group -->
                    </div>
                    <!-- /.form group -->
